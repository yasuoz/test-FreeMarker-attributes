...
<p>after "<code>gradle update_libs</code>", launch tomcat 10.1 Server.</p>
<p><a href="https://stackoverflow.com/questions/79396269/freemarker-template-attributes-becomes-null-in-struts2-customized-anchor">I reported this error.</a></p>
"template/simple/a-close.ftl" is a standard template that assumes that attributes are given from the struts system.<br/>
<p>If I use the standard Anchor class, attributes are given as Map object(→Success),
but if I extend the Anchor class, attributes seem to be null(→Fail).<br/>
It is unclear what controls whether attributes are given.</p>
<ul>
